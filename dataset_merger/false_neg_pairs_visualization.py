...
def false_neg_pairs_visualization(first_img_folder_path, second_img_folder_path, base_folder_path, false_neg_pairs_name, false_neg_artists):
    """
    ...
    Args:
        ...
        base_folder_path: path for save data
        false_neg_pairs_name: false neg pairs id
        false_neg_artists:false neg artist names

    """
    new_floder = 'neg_pairs_visualization_rijks'
    if not os.path.isdir(os.path.join(base_folder_path, new_floder)):
        os.mkdir(os.path.join(base_folder_path, new_floder))
    sub_visual_folder = os.path.join(base_folder_path, new_floder)
    if not os.listdir(sub_visual_folder):
...
if __name__ == '__main__':
    # test
    visualization_folder_path = '/export/home/jli/workspace/readable_code_data/'
    false_neg_artists = dd.io.load('/export/home/jli/workspace/readable_code_data/split_dup_uniq_info/false_pos_pairs_artists_wiki_moma.h5')
    false_neg_pairs_name = dd.io.load('/export/home/jli/workspace/readable_code_data/split_dup_uniq_info/false_pos_pairs_path_wiki_moma.h5')
